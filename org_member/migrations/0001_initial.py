...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('org_member_orgmember', (
            ...
            ('place', self.gf('django.db.models.fields.CharField')(max_length=32)),
    ...
    models = {
        ...
        'groupagenda.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 2, 0, 0)'}),
        ...
        'org_member.orgmember': {
            ...
            'place': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
